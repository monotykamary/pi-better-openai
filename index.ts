 ...
 * spacing shared by neighbouring segments ("Usage: " + "5h: " + "90%") intact.
 */
...
/**
 * Colour a usage line segment by segment: the percentages carry the severity
 * colour while the labels, countdowns and banked resets stay dim.
 */
